...
export default function UserPreview({
  ...
  return (
    <div
      className="relative  flex items-center justify-center w-43.25 h-77 rounded-lg overflow-hidden shadow-lg cursor-pointer hover:opacity-100 transition-all duration-300 ease-in-out transform hover:scale-105"
      onClick={onClick}
    >
      <Image
