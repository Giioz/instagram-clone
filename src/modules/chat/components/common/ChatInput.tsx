...
export default function ChatInput({ input, onInputChange, onSend, socketStatus }: ChatInputProps) {
  return (
    <form onSubmit={onSend} className="flex items-center gap-2 p-4 flex-shrink-0">
      <div className="flex flex-1 items-center rounded-[22px] border border-[#363636] px-4 h-[44px] relative">
        ...
        {!input.trim() ? (
          <div className="flex items-center shrink-0">
            <button type="button" className="flex items-center justify-center p-[8px] hover:text-gray-300 transition-colors">
          ...
          <button
            ...
            className="flex items-center justify-center rounded-full bg-[#4254E0] text-white p-2 w-[50px] text-sm font-semibold hover:bg-[#4338ca] disabled:opacity-40 transition-colors shrink-0 mr-1"
          >
